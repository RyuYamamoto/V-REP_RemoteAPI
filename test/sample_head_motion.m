...
try
	if(clietID>-1)
		...
		[err1]=vrep.simxSetJointTargetPosition(clientID,HipR_JointA0,-target_value,vrep.simx_opmode_oneshot);
        	[err2]=vrep.simxSetJointTargetPosition(clientID,KneeR_JointA0,-target_value,vrep.simx_opmode_oneshot);
