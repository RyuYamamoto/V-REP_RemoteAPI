...
%↓歩幅・時間
Foot = [0 0 0; 3 0.2 0.06; 3.5 0.4 -0.06; 4 0.6 0.06; 4.5 0.8 -0.06; 5 1 0.06;5.5 1.2 -0.06;6 1.4 0.06;6.5 1.6 -0.06;7 1.8 0.06;7.5 2 -0.06;8 2.2 0.06;8.5 2.4 -0.06;9 2.6 0.06;9.5 2.8 -0.06;10 3 0.06;10.5 3.2 -0.06;11 3.4 0.06;11.5 3.6 -0.06;12 3.8 0.06;12.5 4 -0.06;13 4.2 0.06;13.5 4.4 -0.06;14 4.6 0.06;14.5 4.8 -0.06;15 5 0.06;15.5 5.2 -0.06;16 5.4 0.06;16.5 5.6 -0.06;17 5.8 0.06;17.5 6 -0.06;18 6 0;100 0 0];%ステップごとの足の位置
% Foot = [0 0 0; 3 0 0; 3.5 0 0; 4 0 0; 4.5 0 0; 5 0 0; 5.5 0 0; 6 0 0;6.5 0 0;7 0 0;7.5 0 0 ;8 0 0; 100 0 0];%ZMP値一定(0m)
...
for tt = t
	...
	X = [ex; x - xp];%xpは前回のZMP位置(x方向)
	Y = [ey; y - yp];%ypは前回のZMP位置(y方向)
	xp = x;
	yp = y;
	dux = K * X;
	j = 0;
...
subplot(2,1,1);
plot( t,x0,t,x1,'r',t, x2,'--');
grid();
subplot(2,1,2);
plot( t,y0,t, y1,'r',t, y2,'--');
grid();
%subplot(4,1,3);
%plot(x0,y0);
%subplot(4,1,4);
